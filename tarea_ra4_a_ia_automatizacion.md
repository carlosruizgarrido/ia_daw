...
- Modelo/técnica (NLP, clasificación, recomendación, visión, etc.):
    - OCR avanzado (ej. tecnología similar a la usada por [Google Cloud Vision API](https://cloud.google.com/vision/docs/ocr).
...
## 7) Fuente oficial
- Enlace: Documentación oficial de OCR e IA aplicada a documentos — [Google Cloud](https://cloud.google.com/vision/docs/ocr):
